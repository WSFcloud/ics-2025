...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */) { \
  ...
  __VA_ARGS__ ; \
    ...
    INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div, R, if ((sword_t)src2 == 0) { R(rd) = (word_t)-1; } else if ((sword_t)src1 == (sword_t)(1 << (xlen - 1)) && (sword_t)src2 == (sword_t)(-1)) { R(rd) = 1 << (xlen - 1); } else { R(rd) = (sword_t)src1 / (sword_t)src2; });
    ...
    INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh, R, R(rd) = (SEXT(src1, xlen) * SEXT(src2, xlen)) >> xlen);
    INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu, R, R(rd) = (SEXT(src1, xlen) * (uint64_t)src2) >> xlen);
    INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu, R, R(rd) = ((uint64_t)src1 * (uint64_t)src2) >> xlen);
    INSTPAT("0000000 ????? ????? 110 ????? 01100 11", or, R, R(rd) = src1 | src2);
    INSTPAT("??????? ????? ????? 110 ????? 00100 11", ori, I, R(rd) = src1 | imm);
    INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem, R, if ((sword_t)src2 == 0) { R(rd) = (sword_t)src1; } else if ((sword_t)src1 == (sword_t)(1 << (xlen - 1)) && (sword_t)src2 == (sword_t)(-1)) { R(rd) = 0; } else { R(rd) = (sword_t)src1 % (sword_t)src2; });
    ...
    INSTPAT("0000000 ????? ????? 010 ????? 01100 11", slt, R, R(rd) = ((sword_t)src1 < (sword_t)src2 ? 0 : 1));
